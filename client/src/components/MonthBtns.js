...
function MonthBtns({ changeMonth, save, goalState, update }) {
  return (
    <Card>
      <Button color='success' onClick={() => changeMonth("lazy")} className="btn btn-danger mx-4">
        Did Not Deposit This Month
      </Button>
      <Button color='danger' onClick={() => changeMonth("determined")} className="btn btn-success mx-4">
